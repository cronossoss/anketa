...
$sql = "
    SELECT
        ...
        COUNT(CASE WHEN ads.presence_status IN ('present', 'late') THEN 1 END) AS work_days,
        SUM(ads.late_minutes) AS total_late_minutes,
        SUM(ads.overtime_minutes) AS total_overtime_minutes,
        SUM(ads.early_leave_minutes) AS total_early_leave_minutes,
        COUNT(CASE WHEN ads.is_justified = 1 THEN 1 END) AS justified_absences,
        COUNT(CASE WHEN ads.presence_status = 'absent' THEN 1 END) AS absent_days
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h3 class="mb-1">Nedeljni izveštaj prisustva</h3>
        ...
        <div class="card-body">
            <form method="GET">
                <div class="row g-3 align-items-end">
                    <div class="col-md-3">
                        <label class="form-label">Početak nedelje</label>
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="text-muted">Radnici</div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="text-muted">Ukupno kašnjenje</div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="fs-2 fw-bold text-success"><?= round($totalOvertime / 60, 1) ?>h</div>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="text-muted">Odsustva</div>
                    <div class="fs-2 fw-bold text-danger"><?= $totalAbsences ?></div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tbody>
                        <?php foreach ($data as $row): ?>
                            <tr>
                                ...
                                <td><?= round($row['total_overtime_minutes'] / 60, 1) ?>h</td>
                                <td><?= $row['total_early_leave_minutes'] ?> min</td>
                                <td><?= $row['justified_absences'] ?></td>
